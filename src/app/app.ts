...
@Component({
  ...
  imports: [
    ...
    MatButtonModule, MatDividerModule, MatIconModule, MatMenuModule, MatToolbarModule, MatTooltipModule,
    PassphraseGateComponent, LanguageSwitcherComponent, ThemeToggleComponent
  ],
